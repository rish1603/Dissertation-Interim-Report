...
% I have been using project-management tool `Asana' to track tasks and progress (\cite{asana}). Asana allows you to assign tasks with priorities and check them as done when completed. I am using Github as my Version Control System, using appropriate commit messages. 
